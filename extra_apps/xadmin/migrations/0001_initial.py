    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ip_addr', models.CharField(blank=True, max_length=1000, null=True, verbose_name='action ip')),
                ('object_id', models.TextField(blank=True, null=True, verbose_name='object id')),
                ('object_repr', models.CharField(max_length=200, verbose_name='object repr')),
                ('action_flag', models.CharField(db_index=True, max_length=32, verbose_name='action flag')),
                ('message', models.TextField(blank=True, verbose_name='change message')),
                ('data', models.TextField(blank=True, null=True, verbose_name='数据记录')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_name', models.CharField(db_index=True, max_length=64, verbose_name='Url Name')),
