...
from xadmin.forms import AdminAuthenticationForm, CopyLogoutView
...
class LoginView(BaseAdminView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        rsa_js_client = RsaClient()
        _, pub_key_ = rsa_js_client.generate_key()
        context.update({
            'title': self.title,
            'helper': helper,
...
class LogoutView(BaseAdminView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return CopyLogoutView.as_view(**defaults)(request)
