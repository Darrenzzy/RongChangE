...
from django.utils.translation import gettext as _, gettext_lazy as ugettext_lazy
...
class ChangeFieldWidgetWrapper(forms.Widget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        output.append(u'<label class="btn btn-info btn-xs">'
            '<input autocomplete="off" type="checkbox" class="batch-field-checkbox" name="%s" value="%s"%s/> %s</label>' %
            (BATCH_CHECKBOX_NAME, escape(name), (is_required and ' checked="checked"' or ''), _('Change this field')))
