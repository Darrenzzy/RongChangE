...
!function ($) {
	...
	Multiselect.prototype = {
		...
		createOptionValue: function(element) {
			...
			var $li = $('<li><a href="javascript:void(0);" style="padding:0;"><label style="margin:0;padding:3px 20px 3px 20px;height:100%;cursor:pointer;"><input autocomplete="off" style="margin-bottom:5px;" type="' + inputType + '" /></label></a></li>');
		...
		buildDropdown: function () {
			...
			if (this.options.enableFiltering) {
			    $('.multiselect-container', this.$container).prepend('<div class="input-prepend" style="padding:3px;"><span class="add-on"><i class="icon-search"></i></span><input autocomplete="off" class="multiselect-search" type="text" placeholder="' + this.options.filterPlaceholder + '"></div>');
