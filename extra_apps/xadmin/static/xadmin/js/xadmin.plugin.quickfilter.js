;(function($){
  ...
  function addShowMore($,v){
	$(v).nextUntil('li.nav-header').last().after(
		$('<li class="filter-multiselect"><a class="small filter-item" href="#"><input autocomplete="off" class="filter-col-1" type="checkbox"><span class="filter-col-2">Show more</span></a></li>').click(function(e){
			e.preventDefault();
			e.stopPropagation();
  ...
  function addShowLess($,v){
	$(v).nextUntil('li.nav-header').last().after(
		$('<li class="filter-multiselect"><a class="small filter-item" href="#"><input autocomplete="off" class="filter-col-1" type="checkbox"><span class="filter-col-2">Show less</span></a></li>').click(function(e){
			e.preventDefault();
			e.stopPropagation();
