...
UEditorUploadSettings = {
    ...
    "scrawlMaxSize": 104857600,  # 上传大小限制，单位B  100M
    "scrawlUrlPrefix": "",
    "scrawlPathFormat": "",
    ...
    "catcherMaxSize": 104857600,  # 上传大小限制，单位B 100M*/
    # 抓取图片格式显示 */
    "catcherAllowFiles": [".png", ".jpg", ".jpeg", ".gif", ".bmp", ".flv", ".swf", ".mkv", ".avi", ".rm", ".rmvb", '',
                          '.svg', ".mpeg", ".mpg",  ".ogg", ".ogv", ".mov", ".wmv", ".mp4", ".webm", ".mp3", ".wav", ".mid"],
    "catcherUrlPrefix": "",
