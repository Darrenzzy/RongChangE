...
from vendor.health_check.exceptions import ServiceUnavailable
...
class CeleryPingHealthCheck(BaseHealthCheckBackend):
    ...
    def check_status(self):
        ...
        try:
            ...
            self.add_error(ServiceUnavailable("OperationalError error"), exc)
        except ConnectionRefusedError as exc:
            self.add_error(ServiceUnavailable("ConnectionRefusedError error"), exc)
