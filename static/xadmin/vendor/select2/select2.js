...
(function ($, undefined) {
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <div><b></b></div>" ,
                "</a>",
                "<input autocomplete=\"off\" class='select2-focusser select2-offscreen' type='text'/>",
                "<div class='select2-drop' style='display:none'>" ,
                "   <div class='select2-search'>" ,
                "       <input autocomplete=\"off\" type='text' autocomplete='off' class='select2-input'/>" ,
                "   </div>" ,
    ...
    MultiSelect2 = clazz(AbstractSelect2, {
        ...
        onSortStart: function() {
            if (this.select) {
                throw new Error("Sorting of elements is not supported when attached to <select>. Attach to <input autocomplete=\"off\" type='hidden'/> instead.");
            }
